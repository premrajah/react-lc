                ...
                <div className="row mt-3">
                    <div className="col">
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">who we are and how to contact us</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">by using our site you accept these terms</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">there are other terms that may apply to you</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we may make changes to these terms</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we may make changes to our site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we may suspend or withdraw our site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we may transfer this agreement to someone else</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">our site is only for users in the UK</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">you must keep your account details safe</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">how you may use material on our site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">do not rely on information on this site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we are not responsible for websites we link to</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">user-generated content is not approved by us</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">how to complain about content uploaded by other users</h4>
                            <p>If you wish to complain about content uploaded by other users, please contact us on hello@loopcycle.io.</p>
                        </section>

                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">our responsibility for loss or damage suffered by you</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">how we may use your personal information</h4>
                            <p>We will only use your personal information as set out in our Privacy Policy.</p>
                        </section>

                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">uploading content to our site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">rights you are giving us to use material you upload</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">we are not responsible for viruses and you must not introduce them</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">rules about linking to our site</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">which country's laws apply to any disputes?</h4>
                        ...
                        <section className="mb-4">
                            <h4 className="text-capitalize blue-text">our trademarks are registered</h4>
