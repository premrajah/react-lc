                    ...
                    <div className="container   pb-4 pt-4">
                        ...
                        <div className="row justify-content-center pb-2 pt-4 ">
                            ...
                            <div className="col-auto">
                                <h3 className={"blue-text text-heading"}>Have resources to sell?
                                </h3>
                        ...
                        <div className="row justify-content-center pb-4 pt-2 ">
                            ...
                            <div className="col-auto">
                                <p className={"text-gray-light small text-center"}>Create a listing and we’ll notify you when you get a match!
                                </p>
