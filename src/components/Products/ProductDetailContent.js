                    ...
                    <>
                        ...
                        <div className="row  pt-4 pb-4  justify-content-start">
                            <div className="text-left ps-0   col-sm-12 col-xs-12 breadcrumb-row">
                                <Link to={`/my-products${this.props.paramsString?this.props.paramsString:""}`}>My Products</Link><span className={"divider-breadcrumb ps-2 pe-2"}>&#10095;</span><span className={"text-capitalize text-breadcrumb-light"}> {this.state.item.product.name}</span>
