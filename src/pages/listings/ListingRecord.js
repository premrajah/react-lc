...
class ListingRecord extends Component {
    constructor(props) {
        super(props);
            ...
            <Layout>
                <div className="container  pb-4 pt-4">
                    <PageHeader
                        ...
                        pageTitle="Listing Records"
                        subTitle="Listing Records"
                    />

                    <div className="row ">
                        <div className="col-12 d-flex justify-content-start">
                            <Link to="/my-listings" className="btn btn-sm btn-gray-border">
                                Listings
                            </Link>
                        </div>
                    </div>
...
export default connect(mapStateToProps, mapDispachToProps)(ListingRecord);
