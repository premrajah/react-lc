...
export const CURRENT_PRODUCT_KIND = "CURRENT_PRODUCT_KIND";
export const CURRENT_SITE = "CURRENT_SITE";
export const SITE_FORM_SHOW = "SITE_FORM_SHOW";


export const GET_LISTINGS = "GET_LISTINGS";
export const PRODUCT_NPARENT_LIST_PAGE = "PRODUCT_NPARENT_LIST_PAGE";
export const PRODUCT_PAGE_RESET = "PRODUCT_PAGE_RESET";


export const PRODUCT_NPARENT_NO_LIST = "PRODUCT_NPARENT_NO_LIST";
export const SHOW_MULTIPLE_POP_UP = "SHOW_MULTIPLE_POP_UP";
export const PRODUCT_NOT_FOUND = "PRODUCT_NOT_FOUND";

export const TOGGLE_RIGHTBAR = "TOGGLE_RIGHTBAR";
export const TOGGLE_GLOBAL_DIALOG = "TOGGLE_GLOBAL_DIALOG";
export const REFRESH_PAGE = "REFRESH_PAGE";
export const REFRESH_PAGE_SAVE_STATE = "REFRESH_PAGE_SAVE_STATE";


export const EMPTY_CURRENT = "EMPTY_CURRENT";
