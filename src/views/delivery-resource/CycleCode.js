                    ...
                    <div className="container p-2 ">
                        <div className="row justify-content-start pb-3 pt-4 listing-row-border">
                            <div className="col-12">
                                <h3 className={"blue-text text-heading"}>AGG 02</h3>
                            </div>
                            <div className="col-12 mt-2">
                                <p className={""}>
                                    Made by <span className={"green-text"}>Nestle</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row justify-content-start pb-4 pt-3 ">
                            <div className="col-6">
                                ...
                                <p className={"mt-3"}>
                                    Aggregate, an intermediary product which aggregates to another
                                    large product.
                                </p>
                            </div>
