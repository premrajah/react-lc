                                ...
                                <div className="col-md-6 col-sm-12 col-xs-12  pt-4">
                                    ...
                                    <div className="row no-gutters mt-4 web-only">
                                        <div className="col-auto">
                                            ...
                                            <a href="https://loopcycle.io/" target="_blank" rel="noopener noreferrer" type="button" style={{ textDecoration: 'none', color: '#3F3C6E' }} className="mr-2 btn btn-link white-border-btn mt-2 mb-2">
