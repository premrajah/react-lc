        ...
        return (
            <>
                ...
                <div  className={
                    " mt-4  text-right"}>
                    <button
                        data-parent={this.props.item.collection._key}
                    ...
                    >
                        ...
                        {/*{this.props.item.collection.unit_conversions&&this.props.item.collection.unit_conversions.length>0&&*/}
                        {/*<span style={{float:"right"}} className={"text-right"}  data-parent={this.props.item.collection._key}*/}
                        ...
                        {this.props.item.products.map(
                            (subItem, index) => (
                                <SubproductItem
                                    ...
                                    key={index}
                                    item={subItem}
                                    parentId={this.props.item.collection._key}
                                    remove={true}
                                />
                            )
                        )}
...
export default connect(mapStateToProps, mapDispachToProps)(ProductsTab);
