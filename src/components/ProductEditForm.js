...
class ProductEditForm extends Component {
    ...
    loadSelection() {
        let catSelected = this.state.categories.filter(
            (item) => item.name === this.state.item.product.category
        )[0];
        ...
        let subCatSelected = subCategories.filter(
            (item) => item.name === this.state.item.product.type
        )[0];
    ...
    getResources() {
        axios
            .get(baseUrl + "product/" + this.props.productId + "/expand", {
                headers: {
                ...
                <div className="row   justify-content-center create-product-row pb-2 pt-4 ">
                    <div className="col-11">
                        <h3 className={"blue-text text-heading"}>
                            {this.props.isDuplicate ? "Create Duplicate" : "Edit Product"}
                        </h3>
                    </div>
                </div>
                        ...
                        <div className={"col-11"}>
                            <form
                                ...
                                <div className="row no-gutters justify-content-center ">
                                    ...
                                    <div
                                        className={
                                            this.state.moreDetail ? "col-12 mt-4" : "d-none"
                                        }>
                                        <div className="row">
                                            ...
                                            <div className="col-md-4 col-sm-6 col-xs-6">
                                                ...
                                                <TextField
                                                    value={
                                                        this.state.sku
                                                            ? this.state.sku
                                                            : this.state.item.product.sku.sku
                                                    }
                                                    onChange={this.handleChangeProduct.bind(
                                                        this,
                                                        "sku"
                                            ...
                                            <div className="col-md-4 col-sm-6 col-xs-6">
                                                ...
                                                <TextField
                                                    value={
                                                        this.state.upc
                                                            ? this.state.upc
                                                            : this.state.item.product.sku.upc
                                                    }
                                                    onChange={this.handleChangeProduct.bind(
                                                        this,
                                                        "upc"
                                            ...
                                            <div className="col-md-4 col-sm-6 col-xs-6">
                                                ...
                                                <TextField
                                                    value={
                                                        this.state.part_no
                                                            ? this.state.part_no
                                                            : this.state.item.product.sku.part_no
                                                    }
                                                    onChange={this.handleChangeProduct.bind(
                                                        this,
                                                        "part_no"
...
export default connect(mapStateToProps, mapDispachToProps)(ProductEditForm);
