            ...
            <div>
                ...
                <div className="wrapper accountpage">
                    ...
                    <div className={"container"}>
                        ...
                        {this.state.items &&
                            this.state.items.map((item, index) => <ResourceItem item={item} />)}
                ...
                <>
                    <div className={this.state.showFilter ? "wrapper  filter-page" : "d-none"}>
                        <div className="container    pt-3 ">
                            ...
                            <FiltersCat
                                type={"category"}
                                setFilters={(filter) => this.setFilters(filter)}
                            ...
                            <div className="container   search-container pt-3">
                                <div className="row no-gutters  pb-4">
                                    <div
                                        className="col text-left blue-text"
                                        style={{ margin: "auto" }}>
...
export default connect(mapStateToProps, mapDispachToProps)(BrowseResources);
