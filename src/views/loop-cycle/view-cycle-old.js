                                        ...
                                        <div className="row justify-content-start pb-3 pt-4 listing-row-border">
                                            <div className="col-12">
                                                <p className={"green-text text-heading"}>
                                                    @{this.state.item.resource.tags}
                                                </p>
                                            </div>
                                            <div className="col-12 mt-2">
                                                <h5 className={"blue-text text-heading"}>
                                                    {this.state.item.resource.name}
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row justify-content-start pb-3 pt-3 listing-row-border">
                                            <div className="col-auto">
                                                <p
                                                    ...
                                                    {this.state.item.resource.description}
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <div className={"col-8 content-box-listing"}>
                                                    <>
                                                        ...
                                                        <p
                                                            ...
                                                            {this.state.item.resource.category}
                                                        </p>
                                                        <p
                                                            style={{ fontSize: "16px" }}
                                                            className="text-mute mb-1">
                                    ...
                                    <div className={"container"}>
                                        ...
                                        <div className="row  justify-content-start search-container  pb-4">
                                            ...
                                            <div className={"col-auto"}>
                                                ...
                                                <p style={{ fontSize: "18px" }} className="  mb-1">
                                                    {moment(
                                                        this.state.item.resource.availableFrom.value
                                                    ).format("DD MMM YYYY")}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row  justify-content-start search-container  pb-4">
                                            ...
                                            <div className={"col-auto"}>
                                                ...
                                                <p style={{ fontSize: "18px" }} className="  mb-1">
                                                    {moment(
                                                        this.state.item.resource.expiry.value
                                                    ).format("DD MMM YYYY")}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="row  justify-content-start search-container  pb-4">
                                            ...
                                            <div className={"col-auto"}>
                                                ...
                                                <p style={{ fontSize: "18px" }} className="  mb-1">
                                                    {this.state.item.resource.site &&
                                                        this.state.item.resource.site.name}
                                                </p>
                                                <p style={{ fontSize: "18px" }} className="  mb-1">
                                                    {this.state.item.resource.site &&
                                                        this.state.item.resource.site.address}
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-auto ">
                                                    <figure className="avatar avatar-60 border-0">
                                                        <span className={"word-user-sellor"}>
                                                            {this.state.item.producer.org.name.substr(
                                                                0,
                                                                2
                                                            )}
                                                        </span>
                                        ...
                                        <React.Fragment>
                                            {this.state.item.id &&
                                                this.props.userDetail.orgId ===
                                                    this.state.item.producer.org.id &&
                                                this.state.item.state === "created" && (
                                                    <>
                                                        <CssBaseline />
                        ...
                        <Toolbar>
                            <div
                                ...
                                <div className="col-auto">
                                    ...
                                    {this.state.item.id &&
                                        this.state.item.show &&
                                        this.state.item.state === "accepted" && (
                                            <button
                                                onClick={this.consumerConfirmOffer}
                                                type="button"
                                    ...
                                    {this.state.item &&
                                        this.state.item.state === "confirmed" &&
                                        this.state.item.show && (
                                            <button
                                                onClick={this.showPopUpLogistics}
                                                type="button"
                                                className="shadow-sm mr-2 btn btn-link green-btn-border mt-2 mb-2 btn-blue">
                                                Assign Logistics
                                            </button>
                                    ...
                                    {this.state.item.id &&
                                        this.state.item.state === "agreed" &&
                                        this.state.item.show && (
                                            <button
                                                onClick={this.showPopUpTrackingNumber}
                                                type="button"
                                                className="shadow-sm mr-2 btn btn-link green-btn-border mt-2 mb-2 btn-blue">
                                    ...
                                    {this.state.item &&
                                        this.state.item.state === "progress" &&
                                        this.state.item.show && (
                                            <button
                                                onClick={this.orderDelivered}
                                                type="button"
                                                className="shadow-sm mr-2 btn btn-link green-btn-border mt-2 mb-2 btn-blue">
                                                Delivered
                                            </button>
                                    ...
                                    {this.state.item &&
                                        this.state.item.state === "delivered" &&
                                        this.state.item.show && (
                                            <button
                                    ...
                                    {this.state.item &&
                                        this.state.item.state == "received" &&
                                        this.state.item.show && (
                                            <button
                                                onClick={this.orderClose}
                                                type="button"
                                                className="shadow-sm mr-2 btn btn-link green-btn-border mt-2 mb-2 btn-blue">
                                                Close Cycle
                                            </button>
                                ...
                                {this.state.item.state != "received" &&
                                    ...
                                    ((this.state.item.producer &&
                                        this.state.item.producer.org.id ==
                                            this.props.userDetail.orgId) ||
                                        (this.state.item.consumer &&
                                            this.state.item.consumer.org.id ==
                                                this.props.userDetail.orgId)) && (
                                        <div className="col-auto">
                                            <button
                            ...
                            <div className={"row"}>
                                <div className={"col-12 text-center"}>
                                    <h5 className={"text-bold text-center"}>
                                        Please provide a email address of logistics provider :
                                    </h5>
...
export default connect(mapStateToProps, mapDispachToProps)(ViewCycleOld);
