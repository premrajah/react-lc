...
class PaginationLayoutOld extends Component {
...
function LoaderAnimated(){
    ...
    return(
        <div className="wrapper-loader text-center">
            <svg className="hourglass" xmlns="http://www.w3.org/2000/svg mr-4" viewBox="0 0 120 206"
            ...
            <span className={"ms-4 p-2"}>Loading ...</span>
        </div>
    )
}
...
export default (PaginationLayoutOld);
