...
class CreateListing extends Component {
        ...
        if (files && files.length > 0) {
            for (var i = 0; i < files.length; i++) {
                this.getBase64(files[i]).then((data) => {
                    axios
                        .post(baseUrl + "resource/image64", btoa(data), {
                            headers: {
    ...
    loadMatches() {
        for (var i = 0; i < this.state.listResourceData.resources.length; i++) {
            axios
                .get(baseUrl + "resource/" + this.state.listResourceData.resources[i], {
                    headers: {
                        Authorization: "Bearer " + this.props.userDetail.token,
                    },
                })
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="container pt-4 p-2 mt-5 "></div>
                    ...
                    <div className="container add-listing-container   pb-5 pt-5">
                        <div className="row no-gutters">
                            <div className="col-auto">
                                <h3 className={"blue-text text-heading"}>Create a Listing</h3>
                            </div>
                        </div>
                        ...
                        <form onSubmit={this.handleSubmit} className={"mb-5"}>
                            <div className="row no-gutters justify-content-center mt-5">
                                ...
                                <div className="col-12 mt-4">
                                    <TextField
                                        onChange={this.handleChange.bind(this, "serial")}
                                        name={"serial"}
                                        id="outlined-basic"
                                        label="Serial Number"
                                        variant="outlined"
                ...
                <div className={this.state.activePage === 4 ? "" : "d-none"}>
                    ...
                    <div className="container  search-container pb-5 pt-3">
                        <div className="row no-gutters">
                            <div className="col-auto">
                                <h3 className={"blue-text text-heading"}>List Components</h3>
                                <p>
                                    Does this resource have any components that you wish to list?
                                    List them below.
                                </p>
                            </div>
                        </div>
                        <div className="row no-gutters flex-column  mt-2">
                            ...
                            <ComponentItem
                                title="Macerating Unit"
                                subTitle="Kitchen Equipment > Other"
                                serialNo="1234321"
                                imageName={MaceratingImg}
                            />
                            <ComponentItem
                                title="Pump Assembly"
                                subTitle="Kitchen Equipment > Other"
                            ...
                            <ComponentItem
                                ...
                                subTitle="Kitchen Equipment > Other"
                                serialNo="0022331"
                                imageName={DewateringImg}
                            />
                            <ComponentItem
                                title="Control Panel"
                                subTitle="Kitchen Equipment > Other"
                                serialNo="9988776"
                                imageName={ControlImg}
                            />
                            ...
                            <div className="col-12 mb-3">
                                <MuiPickersUtilsProvider utils={MomentUtils}>
                                    <DatePicker
                                        ...
                                        onChange={this.handleChangeDateEndDate.bind(this)}
                                    />
                                </MuiPickersUtilsProvider>
                        ...
                        <div className="row justify-content-center pb-4 pt-2 ">
                            <div className="col-auto">
                                <p className={"text-blue text-center"}>
                                    Your listing has been created. You will be notified when a match
                                    is found.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="row justify-content-start pb-3 pt-4 listing-row-border">
                                    ...
                                    <div className="col-12 mt-2">
                                        <h5 className={"blue-text text-heading"}>
                                            {this.state.listResourceData.name}
                                        </h5>
                                    </div>
                                </div>
                                ...
                                <div className="row justify-content-start pb-3 pt-3 listing-row-border">
                                    <div className="col-auto">
                                        <p
                                            ...
                                            {this.state.listResourceData.description}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className={"container"}>
                                <div className="row  justify-content-start search-container  pb-4">
                                    ...
                                    <div className={"col-auto"}>
                                        ...
                                        <p style={{ fontSize: "18px" }} className="  mb-1">
                                            {this.state.listResourceData.category} >
                                        </p>
                                        <p style={{ fontSize: "18px" }} className="  mb-1">
                                            {this.state.listResourceData.type}
                                        </p>
                                    </div>
                                </div>
                                <div className="row  justify-content-start search-container  pb-4">
                                ...
                                <div className="row  justify-content-start search-container  pb-4">
                                    ...
                                    <div className={"col-auto"}>
                                        ...
                                        <p style={{ fontSize: "18px" }} className="  mb-1">
                                            {this.state.listResourceData.state}
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        {this.state.listResourceData && (
                                            <div className="col-auto">
                                                <Link
                                                    to={
                                                        "/" + this.state.listResourceData &&
                                                        this.state.listResourceData.id
                                                    }
                                                    type="button"
...
export default connect(mapStateToProps, mapDispachToProps)(CreateListing);
