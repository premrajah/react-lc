                            ...
                            <div className={"col-md-8 col-sm-12 col-xs-12 pl-4"}>
                                ...
                                <div className="row  justify-content-start search-container  pb-4">
                                    ...
                                    <div className={"col-auto"}>
                                        ...
                                        <p style={{ fontSize: "18px" }} className="  mb-1">{this.state.item.listing.category}, {this.state.item.listing.type}, {this.state.item.listing.state} {this.state.item.listing.volume} {this.state.item.listing.units}</p>
