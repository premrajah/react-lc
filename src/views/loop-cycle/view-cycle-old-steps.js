                            ...
                            <AppBar
                                ...
                                <Toolbar>
                                    <div
                                        ...
                                        <>
                                            {this.state.item.steps.length > 0 &&
                                                this.state.item.steps[0].nextAction.is_mine && (
                                                    ...
                                                    <div className="col-auto">
                                                        <button
                                                            ...
                                                            type="button"
                                                            className="shadow-sm mr-2 btn btn-link btn-green mt-2 mb-2 btn-green">
                                                            {this.state.item.steps[0].step.stage ===
                                                                "created" && "Accept"}
                                                            {this.state.item.steps[0].step.stage ===
                                                                "accepted" &&
                                        ...
                                        {this.state.item.steps.map((item) => (
                                            <>
                                                <div className="row justify-content-center">
                                                    <div className="col-2">{item.step.name}</div>
                                                    <div className="col-10">
                                                        {item.nextAction.is_mine &&
