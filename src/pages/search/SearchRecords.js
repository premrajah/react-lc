...
class SearchRecords extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            count:0,
            url:baseUrl+"seek?name=Search&relation=belongs_to&include-to=Product:search_for&include-to=Org:any&or=stage==agreed&or=stage==expired",
            searchUrl:baseUrl+"seek?name=Search&relation=belongs_to&include-to=Product:search_for&include-to=Org:any&or=stage==agreed&or=stage==expired",
                                        ...
                                        <div id={item.Search._key} key={item.Search._key}>
                                            <SearchItem
                                                ...
                                                product={item.SearchToProduct[0]?item.SearchToProduct[0].entries[0]
                                                    ?item.SearchToProduct[0].entries[0].Product:null:null}
                                                org={item.SearchToOrg[0]?item.SearchToOrg[0].entries[0]
                                                    ?item.SearchToOrg[0].entries[0].Org:null:null}
                                                showMoreMenu={true}
