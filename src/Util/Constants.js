...
export const PRODUCTS_FILTER_VALUES_KEY = [
    ...
    {key:"name",label:"Name" ,visible:true,sortable:true,flex:1.5},
    {key:"description",label:"Description",visible:false ,sortable:false},
    {key:"condition",label:"Condition" ,visible:false,sortable:false,flex:0.5},
    ...
    {key:"_ts_epoch_ms",label:"Added on",visible:true,sortable:true},
