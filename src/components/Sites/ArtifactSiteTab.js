...
import AddImagesToSite from "./AddImagesToSite";
import DocumentsDisplay from "./DocumentsDisplay";


class ArtifactSiteTab extends Component {
    slug;
    search;
    ...
    render() {
        ...
        return (
            <>
                {!this.props.hideAdd &&
                <AddImagesToSite  hideAdd={this.props.hideAdd?this.props.hideAdd:false}
...
export default connect(mapStateToProps, mapDispachToProps)(ArtifactSiteTab);
