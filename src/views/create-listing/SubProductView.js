...
class SubProductView extends Component {
    ...
    getSite() {
        axios
            .get(baseUrl + "site/" + this.state.item.site_id, {
                headers: {
            ...
            <div>
                {this.state.item && (
                    <>
                        <div className="container-fluid " style={{ padding: "0" }}>
                            <div className="row no-gutters  justify-content-center">
                                ...
                                <div className="col-12">
                                    <h3 className={"blue-text text-heading"}>Products Details</h3>
                                </div>
                        ...
                        <div className="col-12">
                            <h3 className={"blue-text text-heading"}>Sub Products</h3>
                        </div>
...
export default connect(mapStateToProps, mapDispachToProps)(SubProductView);
